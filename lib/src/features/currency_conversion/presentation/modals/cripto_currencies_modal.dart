...
class CryptoCurrenciesModal extends StatefulWidget {
  const CryptoCurrenciesModal({
    super.key,
  });

  @override
  State<CryptoCurrenciesModal> createState() => _CryptoCurrenciesModalState();
}

class _CryptoCurrenciesModalState extends State<CryptoCurrenciesModal> {
  @override
        ...
        builder: (context, state) {
          ...
          return ListView.separated(
            ...
            itemBuilder: (context, index) {
              ...
              return CurrencyItem(
                currency: currency,
                isSelected: currency == swapCubit.state.selectedCryptoByState,
                onTap: () {
                  context
